...
#
setup_keywords['name'] = 'desi_sandbox'
setup_keywords['description'] = 'DESI Sandbox'
setup_keywords['author'] = 'Prochaska and Associates'
setup_keywords['author_email'] = 'xavier@ucolick.org'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/profxj/desi_sandbox'
#
...
setup_keywords['package_data'] = {'desi_sandbox': data_files,
                                  '': ['*.rst', '*.txt', '*.yaml']}
